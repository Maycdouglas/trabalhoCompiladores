...
public class langLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DATA", "RETURN", "READ", "PRINT", "IF", "ELSE", "ITERATE", "PLUS", "MINUS", 
			"MUL", "DIV", "MOD", "EQ", "NEQ", "LT", "GT", "AND", "NOT", "ASSIGN", 
			"DCOLON", "COLON", "SEMI", "COMMA", "DOT", "LPAREN", "RPAREN", "LBRACE", 
			"RBRACE", "LBRACK", "RBRACK", "LINE_COMMENT", "BLOCK_COMMENT", "WS"
		};
	}
